...
class FontX : public COleDispatchDriver
{
public:
	FontX() {}		// Calls COleDispatchDriver default constructor
	FontX(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	FontX(const FontX& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
